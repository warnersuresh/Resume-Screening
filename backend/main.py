...
auth_db = client["user_auth_db"]
users_collection = auth_db["users"]  # Use users collection instead of resumes

profile_db = client["profile_db"]
profile_collection = profile_db["profiles"]

# Sample job description for ranking resumes
JOB_DESCRIPTION = """
...
async def get_all_resumes():
    users = list(users_collection.find({}, {"_id": 0, "email": 1, "filename": 1, "rank": 1}))
    return users
