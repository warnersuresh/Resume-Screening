...
class ReportGeneratorService {
    ...
    structureService;
    groq;
    constructor(atsService, jobMatchService, structureService, groqClient) {
        this.atsService = atsService;
        this.jobMatchService = jobMatchService;
        this.structureService = structureService;
        this.groq = groqClient;
    }
    async generateReport(resumeText, jobDescription) {
        ...
        const detailedFeedback = await this.generateDetailedFeedback(resumeText, jobDescription, { atsScore, jobMatch, structure, suggestions });
        return {
            atsScore,
            jobMatch,
            structure,
    ...
    async generateDetailedFeedback(resumeText, jobDescription, analysis) {
